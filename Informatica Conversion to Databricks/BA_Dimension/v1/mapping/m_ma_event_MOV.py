...
# DBTITLE 1, USR_MA_MOVEMENT_CTRL_1
...
df_1.createOrReplaceTempView("USR_MA_MOVEMENT_CTRL_1")
...
df_4.createOrReplaceTempView("LOCATION_TYPE_4")

# COMMAND ----------

# DBTITLE 1, SQ_Shortcut_to_MA_EVENT1_5

df_5=spark.sql("""
    SELECT
        M.MA_EVENT_ID MA_EVENT_ID,
        D.START_DT AS NEW_START_DT,
        M.START_DT AS ORIG_START_DT,
        D.END_DT AS NEW_END_DT,
        M.END_DT AS ORIG_END_DT,
        NVL(UMMC.MA_EVENT_TYPE_ID,
        M.MA_EVENT_TYPE_ID) AS NEW_MA_EVENT_TYPE_ID,
        M.MA_EVENT_TYPE_ID AS ORIG_MA_EVENT_TYPE_ID,
        NVL(UMMC.MA_EVENT_SOURCE_ID,
        M.MA_EVENT_SOURCE_ID) AS NEW_MA_EVENT_SOURCE_ID,
        M.MA_EVENT_SOURCE_ID AS ORIG_MA_EVENT_SOURCE_ID,
        M.FISCAL_MO,
        M.MOVEMENT_ID,
        M.VALUATION_CLASS_CD,
        NVL(UMMC.GL_ACCT_NBR,
        M.GL_ACCT_NBR) AS NEW_GL_ACCT_NBR,
    ...
    FROM
        MA_EVENT M 
    LEFT JOIN
        USR_MA_MOVEMENT_CTRL UMMC 
            ON M.FISCAL_MO = UMMC.FISCAL_MO 
    ...
    JOIN
        LOCATION_TYPE LT 
            ON M.LOCATION_TYPE_ID = LT.LOCATION_TYPE_ID 
    JOIN
        (
            SELECT
                FISCAL_MO,
...
df_5.createOrReplaceTempView("SQ_Shortcut_to_MA_EVENT1_5")

# COMMAND ----------

# DBTITLE 1, EXP_ORIG_6
...
df_6=spark.sql("""
    SELECT
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        SQ_Shortcut_to_MA_EVENT1_5""")

df_6.createOrReplaceTempView("EXP_ORIG_6")

# COMMAND ----------

# DBTITLE 1, SQ_Shortcut_to_MA_EVENT_7
...
df_7=spark.sql("""
    ...
    JOIN
        LOCATION_TYPE LT 
            ON UMMC.LOCATION_TYPE_ID = LT.LOCATION_TYPE_ID 
    JOIN
        (
            SELECT
                FISCAL_MO,
            ...
            ON UMMC.FISCAL_MO = D.FISCAL_MO 
    LEFT JOIN
        MA_EVENT M 
            ON UMMC.FISCAL_MO = M.FISCAL_MO 
...
df_7.createOrReplaceTempView("SQ_Shortcut_to_MA_EVENT_7")
...
df_8=spark.sql("""
    ...
    ORDER BY
        ...
        SQ_Shortcut_to_MA_EVENT_7.NEW_START_DT AS NEW_START_DT,
        SQ_Shortcut_to_MA_EVENT_7.ORIG_START_DT AS ORIG_START_DT,
        SQ_Shortcut_to_MA_EVENT_7.NEW_END_DT AS NEW_END_DT,
        SQ_Shortcut_to_MA_EVENT_7.ORIG_END_DT AS ORIG_END_DT,
        SQ_Shortcut_to_MA_EVENT_7.NEW_MA_EVENT_TYPE_ID AS NEW_MA_EVENT_TYPE_ID,
        SQ_Shortcut_to_MA_EVENT_7.ORIG_MA_EVENT_TYPE_ID AS ORIG_MA_EVENT_TYPE_ID,
        SQ_Shortcut_to_MA_EVENT_7.NEW_MA_EVENT_SOURCE_ID AS NEW_MA_EVENT_SOURCE_ID,
        SQ_Shortcut_to_MA_EVENT_7.ORIG_MA_EVENT_SOURCE_ID AS ORIG_MA_EVENT_SOURCE_ID,
        SQ_Shortcut_to_MA_EVENT_7.FISCAL_MO AS FISCAL_MO,
        SQ_Shortcut_to_MA_EVENT_7.MOVEMENT_ID AS MOVEMENT_ID,
        SQ_Shortcut_to_MA_EVENT_7.VALUATION_CLASS_CD AS VALUATION_CLASS_CD,
        SQ_Shortcut_to_MA_EVENT_7.NEW_GL_ACCT_NBR AS NEW_GL_ACCT_NBR,
        SQ_Shortcut_to_MA_EVENT_7.ORIG_GL_ACCT_NBR AS ORIG_GL_ACCT_NBR,
        SQ_Shortcut_to_MA_EVENT_7.LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
        SQ_Shortcut_to_MA_EVENT_7.NEW_MA_EVENT_DESC AS NEW_MA_EVENT_DESC,
        SQ_Shortcut_to_MA_EVENT_7.ORIG_MA_EVENT_DESC AS ORIG_MA_EVENT_DESC,
        SQ_Shortcut_to_MA_EVENT_7.MA_PCT_IND AS MA_PCT_IND,
        SQ_Shortcut_to_MA_EVENT_7.NEW_MA_AMT AS NEW_MA_AMT,
        SQ_Shortcut_to_MA_EVENT_7.ORIG_MA_AMT AS ORIG_MA_AMT,
        current_timestamp AS UPDATE_DT,
        current_timestamp AS LOAD_DT,
        SQ_Shortcut_to_MA_EVENT_7.INS_UPD_DEL_FLAG AS INS_UPD_DEL_FLAG,
        SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        SEQ_MA_EVENT_ID 
    INNER JOIN
        SQ_Shortcut_to_MA_EVENT_7 
            ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_Shortcut_to_MA_EVENT_7.Monotonically_Increasing_Id""")
...
# DBTITLE 1, UNI_NEW_ORIG_9

df_9=spark.sql("""SELECT FISCAL_MO AS FISCAL_MO,
INS_UPD_DEL_FLAG AS INS_UPD_DEL_FLAG,
LOAD_DT AS LOAD_DT,
LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
MA_EVENT_ID AS MA_EVENT_ID,
...
ORIG_START_DT AS ORIG_START_DT,
UPDATE_DT AS UPDATE_DT,
VALUATION_CLASS_CD AS VALUATION_CLASS_CD FROM EXP_ORIG_6 UNION ALL SELECT FISCAL_MO AS FISCAL_MO,
INS_UPD_DEL_FLAG AS INS_UPD_DEL_FLAG,
LOAD_DT AS LOAD_DT,
LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
MA_EVENT_ID AS MA_EVENT_ID,
...
ORIG_START_DT AS ORIG_START_DT,
UPDATE_DT AS UPDATE_DT,
VALUATION_CLASS_CD AS VALUATION_CLASS_CD FROM EXP_NEW_8""")

df_9.createOrReplaceTempView("UNI_NEW_ORIG_9")
...
df_11.createOrReplaceTempView("EXP_INS_UPD_DEL_11")
...
MA_MAX_AMT AS MA_MAX_AMT,
INS_UPD_DEL_FLAG AS INS_UPD_DEL_FLAG FROM EXP_INS_UPD_DEL_11""")
