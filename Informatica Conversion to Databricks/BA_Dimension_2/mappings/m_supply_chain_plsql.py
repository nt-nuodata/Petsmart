...
SESS_START_TIME_output AS SESS_START_TIME_output FROM SQL_RUN_SQL_FROM_QUERY_ARG_13""")
...
Monotonically_Increasing_Id AS Monotonically_Increasing_Id FROM EXP_OUTPUT_16""")
...
EXEC_USER AS EXEC_USER FROM Shortcut_to_mplt_GENERIC_SQL_17""")
