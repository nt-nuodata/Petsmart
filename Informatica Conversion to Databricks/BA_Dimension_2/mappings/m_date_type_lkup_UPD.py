...
df_3=spark.sql("""
    ...
    ORDER BY
        ...
        0))) AS TW_LW_FLAG,
        SQ_Shortcut_To_WEEKS_2.Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        SQ_Shortcut_To_WEEKS_2 
    INNER JOIN
        SEQ_DATE_TYPE_ID 
            ON SQ_Shortcut_To_WEEKS_2.Monotonically_Increasing_Id = SEQ_DATE_TYPE_ID.Monotonically_Increasing_Id""")
...
DATE_TYPE_DESC3 AS DATE_TYPE_DESC3,
DATE_TYPE_5WK_STATUS AS DATE_TYPE_5WK_STATUS,
TW_LW_FLAG AS TW_LW_FLAG FROM UPD_DATE_TYPE_ID1_4""")