...
df_0.createOrReplaceTempView("LOCATION_AREA_0")
...
df_1=spark.sql("""
    ...
    FROM
        ...
        WHERE
            ...
            AND la.area_id = 1 
            AND la.loc_area_end_dt >= CURRENT_DATE) a,
        (SELECT
            la.location_id,
            la.area_id,
            la.sq_ft_amt 
        ...
        WHERE
            la.location_id = sp.location_id 
            AND la.area_id = 2 
            AND la.loc_area_end_dt >= CURRENT_DATE) b 
    WHERE
...
DELETE_DT AS DELETE_DT,
UPDATE_DT AS UPDATE_DT,
LOAD_DT AS LOAD_DT FROM ASQ_Shortcut_To_LOCATION_AREA_1""")
