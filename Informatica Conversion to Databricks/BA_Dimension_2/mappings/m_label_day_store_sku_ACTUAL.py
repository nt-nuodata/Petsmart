...
# DBTITLE 1, ZTB_LABEL_CHGS_PRE_0
...
df_0.createOrReplaceTempView("ZTB_LABEL_CHGS_PRE_0")

# COMMAND ----------

# DBTITLE 1, SQ_Shortcut_to_ZTB_LABEL_CHGS_PRE_1
...
df_1=spark.sql("""
    SELECT
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        ZTB_LABEL_CHGS_PRE_0""")

df_1.createOrReplaceTempView("SQ_Shortcut_to_ZTB_LABEL_CHGS_PRE_1")
...
df_2=spark.sql("""
    SELECT
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        SQ_Shortcut_to_ZTB_LABEL_CHGS_PRE_1""")
...
# DBTITLE 1, LKP_GET_TIME_DIMENSIONS_4
...
df_4.createOrReplaceTempView("LKP_GET_TIME_DIMENSIONS_4")

# COMMAND ----------

# DBTITLE 1, LKP_GET_PRODUCT_ID_5
...
df_5.createOrReplaceTempView("LKP_GET_PRODUCT_ID_5")
...
df_6=spark.sql("""
    SELECT
        ...
        LKP_GET_PRODUCT_ID_5.PRODUCT_ID AS PRODUCT_ID,
        ...
        LKP_GET_TIME_DIMENSIONS_4.WEEK_DT AS WEEK_DT,
        LKP_GET_TIME_DIMENSIONS_4.FISCAL_WK AS FISCAL_WK,
        LKP_GET_TIME_DIMENSIONS_4.FISCAL_MO AS FISCAL_MO,
        LKP_GET_TIME_DIMENSIONS_4.FISCAL_YR AS FISCAL_YR,
        EXP_LBL_FIELDS_CONVERSION_2.SUPPRESSED_FLAG AS SUPPRESSED_FLAG,
        EXP_LBL_FIELDS_CONVERSION_2.LABEL_CNT AS LABEL_CNT,
        current_timestamp AS UPDATE_TSTMP,
        LKP_GET_LOCATION_ID_3.Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        LKP_GET_LOCATION_ID_3 
    INNER JOIN
        LKP_GET_TIME_DIMENSIONS_4 
            ON LKP_GET_LOCATION_ID_3.Monotonically_Increasing_Id = LKP_GET_TIME_DIMENSIONS_4.Monotonically_Increasing_Id 
    INNER JOIN
        LKP_GET_PRODUCT_ID_5 
            ON LKP_GET_LOCATION_ID_3.Monotonically_Increasing_Id = LKP_GET_PRODUCT_ID_5.Monotonically_Increasing_Id 
    INNER JOIN
        EXP_LBL_FIELDS_CONVERSION_2 
            ON LKP_GET_LOCATION_ID_3.Monotonically_Increasing_Id = EXP_LBL_FIELDS_CONVERSION_2.Monotonically_Increasing_Id""")
...
df_8=spark.sql("""
    ...
    WHERE
        LABEL_DAY_STORE_SKU.ACTUAL_FLAG = 1 
