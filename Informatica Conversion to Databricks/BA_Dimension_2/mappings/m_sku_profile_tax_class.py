...
# DBTITLE 1, ASQ_SHORTCUT_TO_PRODUCT_PRE_1
...
df_1.createOrReplaceTempView("ASQ_SHORTCUT_TO_PRODUCT_PRE_1")
...
TAX_CLASS_DESC AS TAX_CLASS_DESC FROM ASQ_SHORTCUT_TO_PRODUCT_PRE_1""")
