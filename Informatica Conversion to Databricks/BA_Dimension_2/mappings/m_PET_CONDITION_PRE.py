...
# COMMAND ----------
# DBTITLE 1, HTTP_Get_Pet_Condition_3
...
df_3.createOrReplaceTempView("HTTP_Get_Pet_Condition_3")

# COMMAND ----------
# DBTITLE 1, exp_Cleanup_XML1_4
...
df_4=spark.sql("""
    SELECT
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        HTTP_Get_Pet_Condition_3""")

df_4.createOrReplaceTempView("exp_Cleanup_XML1_4")

# COMMAND ----------
# DBTITLE 1, xml_Parse_Pet_Condition_5
...
df_5.createOrReplaceTempView("xml_Parse_Pet_Condition_5")

# COMMAND ----------
# DBTITLE 1, exp_TRANSFORM1_6


df_6=spark.sql("""
    SELECT
        (CAST(LTRIM(RTRIM(ConditionId)) AS DECIMAL (38,
        0))) AS CONDITION_ID,
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        xml_Parse_Pet_Condition_5""")

df_6.createOrReplaceTempView("exp_TRANSFORM1_6")

# COMMAND ----------
# DBTITLE 1, PET_CONDITION_PRE


spark.sql("""INSERT INTO PET_CONDITION_PRE SELECT CONDITION_ID AS CONDITION_ID,
DESCRIPTION AS DESCRIPTION,
IS_ACTIVE AS IS_ACTIVE,
LOAD_TSTMP AS LOAD_TSTMP FROM exp_TRANSFORM1_6""")