...
# DBTITLE 1, HTTP_Get_Pet_Gender_3
...
df_3.createOrReplaceTempView("HTTP_Get_Pet_Gender_3")

# COMMAND ----------

# DBTITLE 1, exp_Cleanup_XML11_4
...
df_4=spark.sql("""
    SELECT
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        HTTP_Get_Pet_Gender_3""")

df_4.createOrReplaceTempView("exp_Cleanup_XML11_4")

# COMMAND ----------

# DBTITLE 1, xml_Parse_Gender_5
...
df_5.createOrReplaceTempView("xml_Parse_Gender_5")

# COMMAND ----------

# DBTITLE 1, exp_TRANSFORM11_6

df_6=spark.sql("""
    SELECT
        (CAST(LTRIM(RTRIM(GenderId)) AS DECIMAL (38,
        0))) AS GENDER_ID,
        LTRIM(RTRIM(SystemDescription)) AS NAME,
        1 AS IS_ACTIVE,
...
df_6.createOrReplaceTempView("exp_TRANSFORM11_6")

# COMMAND ----------

# DBTITLE 1, PET_GENDER_PRE

spark.sql("""INSERT INTO PET_GENDER_PRE SELECT GENDER_ID AS GENDER_ID,
NAME AS NAME,
IS_ACTIVE AS IS_ACTIVE,
LOAD_TSTMP AS LOAD_TSTMP FROM exp_TRANSFORM11_6""")
