...
df_0.createOrReplaceTempView("EQUINE_MERCH_0")

# COMMAND ----------
# DBTITLE 1, SITE_PROFILE_PRE_1
...
df_1.createOrReplaceTempView("SITE_PROFILE_PRE_1")
...
df_2=spark.sql("""
    ...
    LEFT OUTER JOIN
        EQUINE_MERCH EQ 
            ON RTRIM(SP.EQUINE_MERCH_DESC) = RTRIM(EQ.EQUINE_MERCH_DESC)""")
...
LOAD_DT AS LOAD_DT FROM EXP_DEFAULT_VALUE_3""")