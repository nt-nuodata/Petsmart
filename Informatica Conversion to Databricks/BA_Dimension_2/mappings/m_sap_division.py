...
# DBTITLE 1, SAP_DIVISION

spark.sql("""INSERT INTO SAP_DIVISION SELECT SAP_DIVISION_ID AS SAP_DIVISION_ID,
SAP_DIVISION_DESC AS SAP_DIVISION_DESC,
MERCH_SVP_ID AS MERCH_SVP_ID,
MERCH_VP_ID AS MERCH_VP_ID FROM ASQ_Shortcut_to_SKU_PROFILE_PRE_1""")
