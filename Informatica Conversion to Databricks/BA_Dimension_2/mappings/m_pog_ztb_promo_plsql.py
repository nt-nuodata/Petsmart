...
# DBTITLE 1, POG_ZTB_PROMOHST_PRE_1
...
df_1.createOrReplaceTempView("POG_ZTB_PROMOHST_PRE_1")
...
df_4=spark.sql("""SELECT JOB_NAME AS MAP_NAME FROM ASQ_Shortcut_To_QUERY_ARGUMENTS_3""")
...
SQL_TX2 AS SQL_TX2,
SQL_TX3 AS SQL_TX3 FROM Shortcut_to_mplt_GENERIC_SQL_16""")
