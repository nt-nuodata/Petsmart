...
spark.sql("""INSERT INTO SAP_CLASS SELECT SAP_CLASS_ID AS SAP_CLASS_ID,
SAP_CLASS_DESC AS SAP_CLASS_DESC,
SAP_DEPT_ID AS SAP_DEPT_ID FROM ASQ_Shortcut_to_SKU_PROFILE_PRE_1""")
