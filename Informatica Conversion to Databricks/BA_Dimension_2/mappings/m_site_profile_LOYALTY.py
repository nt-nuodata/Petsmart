...
df_2=spark.sql("""
    SELECT
        SP.LOCATION_ID,
        LP.PETSMART_DMA_CD,
        NVL(LP.LOYALTY_PGM_TYPE_ID,
        0) AS LOYALTY_PGM_TYPE_ID,
        NVL(LP.LOYALTY_PGM_STATUS_ID,
        0) AS LOYALTY_PGM_STATUS_ID,
        NVL(LP.LOYALTY_PGM_START_DT,
        TO_DATE(99991231,
        'YYYYMMDD')) AS LOYALTY_PGM_START_DT,
        NVL(LP.LOYALTY_PGM_CHANGE_DT,
        TO_DATE(99991231,
        'YYYYMMDD')) AS LOYALTY_PGM_CHANGE_DT,
        CURRENT_DATE 
    FROM
        SITE_PROFILE SP,
        LOYALTY_PRE LP 
    WHERE
        LP.STORE_NBR = SP.STORE_NBR""")
...
df_3=spark.sql("""
    SELECT
        LOCATION_ID AS LOCATION_ID,
        PETSMART_DMA_CD AS PETSMART_DMA_CD,
        IN_LOYALTY_PGM_TYPE_ID AS IN_LOYALTY_PGM_TYPE_ID,
        IN_LOYALTY_PGM_STATUS_ID AS IN_LOYALTY_PGM_STATUS_ID,
        IN_LOYALTY_PGM_START_DT AS IN_LOYALTY_PGM_START_DT,
        IN_LOYALTY_PGM_CHANGE_DT AS IN_LOYALTY_PGM_CHANGE_DT,
        IFF(LOYALTY_PGM_TYPE_ID = NULL,
        0,
        (CAST(LOYALTY_PGM_TYPE_ID AS DECIMAL (38,
        0)))) AS OUT_LOYALTY_PGM_TYPE_ID,
        IFF(LOYALTY_PGM_STATUS_ID = NULL,
        0,
        (CAST(LOYALTY_PGM_STATUS_ID AS DECIMAL (38,
        0)))) AS OUT_LOYALTY_PGM_STATUS_ID,
        IFF(LOYALTY_PGM_START_DT = NULL,
        to_date(TO_CHAR(12319999),
        'MM/DD/YYYY'),
        LOYALTY_PGM_START_DT) AS OUT_LOYALTY_PGM_START_DT,
        IFF(LOYALTY_PGM_CHANGE_DT = NULL,
        to_date(TO_CHAR(12319999),
        'MM/DD/YYYY'),
        LOYALTY_PGM_CHANGE_DT) AS OUT_LOYALTY_PGM_CHANGE_DT,
        UPDATE_DT AS UPDATE_DT,
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        ASQ_Shortcut_To_LOYALTY_PRE_2""")

df_3.createOrReplaceTempView("EXP_NVL_3")
...
DELETE_DT AS DELETE_DT,
UPDATE_DT AS UPDATE_DT,
LOAD_DT AS LOAD_DT FROM EXP_NVL_3""")
