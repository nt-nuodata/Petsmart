...
# COMMAND ----------
# DBTITLE 1, ASQ_Shortcut_To_SKU_PROFILE_1
...
df_1=spark.sql("""
    ...
    FROM
        SKU_PROFILE 
    WHERE
        SUBS_HIST_FLAG IS NULL 
        OR (
            SUBS_CURR_FLAG
        ) IS NULL""")

df_1.createOrReplaceTempView("ASQ_Shortcut_To_SKU_PROFILE_1")
...
ZDISCO_STR_DT AS ZDISCO_STR_DT,
ZDISCO_STR_OWNRSHP_DT AS ZDISCO_STR_OWNRSHP_DT,
ZDISCO_STR_WRT_OFF_DT AS ZDISCO_STR_WRT_OFF_DT FROM ASQ_Shortcut_To_SKU_PROFILE_1""")
...
RX_FLAG AS RX_FLAG,
UPDATE_DT AS UPDATE_DT,
LOAD_DT AS LOAD_DT FROM ASQ_Shortcut_To_SKU_PROFILE_1""")