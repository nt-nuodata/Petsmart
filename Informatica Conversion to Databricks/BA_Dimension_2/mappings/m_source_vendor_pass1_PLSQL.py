...
# DBTITLE 1, SQ_Shortcut_To_SKU_VENDOR_DAY_2

df_2=spark.sql("""
    SELECT
        'SOURCE_VENDOR_PASS1'""")

df_2.createOrReplaceTempView("SQ_Shortcut_To_SKU_VENDOR_DAY_2")

# COMMAND ----------

# DBTITLE 1, Shortcut_to_mplt_GENERIC_SQL_15

df_3=spark.sql("""SELECT JOB_NAME AS MAP_NAME FROM SQ_Shortcut_To_SKU_VENDOR_DAY_2""")
