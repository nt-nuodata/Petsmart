...
# COMMAND ----------
# DBTITLE 1, VENDOR_SITE_PO_COND_1
...
df_1.createOrReplaceTempView("VENDOR_SITE_PO_COND_1")
...
df_3=spark.sql("""
    SELECT
        ...
        VSPCP.LOCATION_ID,
        VSPCP.PO_COND_CD,
        VSPCP.PO_COND_EFF_DT,
        VSPCP.PO_COND_END_DT,
        VSPCP.DELETE_IND,
        VSPCP.PO_COND_RATE_AMT,
        VSPC.VENDOR_ID OLD_VENDOR_ID,
        CURRENT_DATE,
        VSPCP.VENDOR_SUBRANGE_CD 
    FROM
        (SELECT
            COND.VENDOR_ID,
            SITE.LOCATION_ID,
        ...
        FROM
            VENDOR_SITE_PO_COND_PRE COND,
            SITE_PROFILE SITE 
        WHERE
            COND.STORE_NBR = SITE.STORE_NBR) VSPCP 
    LEFT OUTER JOIN
        VENDOR_SITE_PO_COND VSPC 
            ON VSPCP.LOCATION_ID = VSPC.LOCATION_ID 
...
spark.sql("""INSERT INTO VENDOR_SITE_PO_COND SELECT VENDOR_ID AS VENDOR_ID,
VENDOR_SUBRANGE_CD AS VENDOR_SUBRANGE_CD,
LOCATION_ID AS LOCATION_ID,
PO_COND_CD AS PO_COND_CD,
PO_COND_EFF_DT AS PO_COND_EFF_DT,
...
PO_COND_END_DT AS PO_COND_END_DT,
DELETE_IND AS DELETE_IND,
LOAD_DT AS LOAD_DT FROM UPD_VENDOR_SITE_PO_COND_4""")