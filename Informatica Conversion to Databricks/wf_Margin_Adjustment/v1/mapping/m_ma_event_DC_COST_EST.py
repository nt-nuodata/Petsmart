...
# COMMAND ----------
# DBTITLE 1, USR_MA_DC_COST_CTRL_1
...
df_1.createOrReplaceTempView("USR_MA_DC_COST_CTRL_1")
...
# COMMAND ----------
# DBTITLE 1, SQ_USR_MA_DC_COST_CTRL_INSERTS_4
...
df_4=spark.sql("""
    SELECT
        ...
        UMDCC.MA_EVENT_TYPE_ID,
        10 MA_EVENT_SOURCE_ID,
        UMDCC.FISCAL_MO,
        UMDCC.SAP_CATEGORY_ID,
        UMDCC.LOCATION_TYPE_ID,
        UMDCC.COMPANY_ID,
        'DC Cost Est: FiscalMo=' || UMDCC.FISCAL_MO::VARCHAR (10) || '; SAP Category=' || UMDCC.SAP_CATEGORY_ID::VARCHAR (10) MA_EVENT_DESC,
        1 MA_PCT_IND,
        UMDCC.DC_COST_PCT * -100 NEW_MA_AMT,
        NEW_MA_AMT AS ORIG_MA_AMT,
        'I' AS INS_UPD_FLAG 
    FROM
        USR_MA_DC_COST_CTRL UMDCC 
    JOIN
        (
            SELECT
                FISCAL_MO,
            ...
            ON UMDCC.FISCAL_MO = D.FISCAL_MO 
    LEFT JOIN
        MA_EVENT M 
            ON UMDCC.MA_EVENT_TYPE_ID = M.MA_EVENT_TYPE_ID 
...
df_4.createOrReplaceTempView("SQ_USR_MA_DC_COST_CTRL_INSERTS_4")
...
df_5=spark.sql("""
    ...
    ORDER BY
        ...
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.NEW_START_DT AS NEW_START_DT,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.ORIG_START_DT AS ORIG_START_DT,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.NEW_END_DT AS NEW_END_DT,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.ORIG_END_DT AS ORIG_END_DT,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.MA_EVENT_TYPE_ID AS MA_EVENT_TYPE_ID,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.MA_EVENT_SOURCE_ID AS MA_EVENT_SOURCE_ID,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.FISCAL_MO AS FISCAL_MO,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.SAP_CATEGORY_ID AS SAP_CATEGORY_ID,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.COMPANY_ID AS COMPANY_ID,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.MA_EVENT_DESC AS MA_EVENT_DESC,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.MA_PCT_IND AS MA_PCT_IND,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.NEW_MA_AMT AS NEW_MA_AMT,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.ORIG_MA_AMT AS ORIG_MA_AMT,
        current_timestamp AS UPDATE_DT,
        current_timestamp AS LOAD_DT,
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4.INS_UPD_FLAG AS INS_UPD_FLAG,
        SEQ_MA_EVENT_ID.Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        SEQ_MA_EVENT_ID 
    INNER JOIN
        SQ_USR_MA_DC_COST_CTRL_INSERTS_4 
            ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_USR_MA_DC_COST_CTRL_INSERTS_4.Monotonically_Increasing_Id""")
...
# COMMAND ----------
# DBTITLE 1, SQ_USR_MA_DC_COST_CTRL_UPDATES_6
...
df_6.createOrReplaceTempView("SQ_USR_MA_DC_COST_CTRL_UPDATES_6")
...
df_7=spark.sql("""
    SELECT
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        SQ_USR_MA_DC_COST_CTRL_UPDATES_6""")

df_7.createOrReplaceTempView("EXP_ORIG_7")

# COMMAND ----------
# DBTITLE 1, UN_INS_UPD_DEL_8


df_8=spark.sql("""SELECT COMPANY_ID AS COMPANY_ID,
FISCAL_MO AS FISCAL_MO,
INS_UPD_FLAG AS INS_UPD_FLAG,
LOAD_DT AS LOAD_DT,
LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
...
ORIG_START_DT AS ORIG_START_DT,
SAP_CATEGORY_ID AS SAP_CATEGORY_ID,
UPDATE_DT AS UPDATE_DT FROM EXP_NEW_5 UNION ALL SELECT COMPANY_ID AS COMPANY_ID,
FISCAL_MO AS FISCAL_MO,
INS_UPD_FLAG AS INS_UPD_FLAG,
LOAD_DT AS LOAD_DT,
LOCATION_TYPE_ID AS LOCATION_TYPE_ID,
...
df_8.createOrReplaceTempView("UN_INS_UPD_DEL_8")
