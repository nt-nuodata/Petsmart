...
# DBTITLE 1, SQ_MA_DC_COST_ADJ_CTRL_UPDATES_4
...
df_4.createOrReplaceTempView("SQ_MA_DC_COST_ADJ_CTRL_UPDATES_4")
...
df_5=spark.sql("""
    SELECT
        ...
        Monotonically_Increasing_Id AS Monotonically_Increasing_Id 
    FROM
        SQ_MA_DC_COST_ADJ_CTRL_UPDATES_4""")

df_5.createOrReplaceTempView("EXP_ORIG_5")

# COMMAND ----------

# DBTITLE 1, SQ_MA_DC_COST_ADJ_CTRL_INSERTS_6
...
df_6.createOrReplaceTempView("SQ_MA_DC_COST_ADJ_CTRL_INSERTS_6")
...
df_7=spark.sql("""
    ...
    INNER JOIN
        SQ_MA_DC_COST_ADJ_CTRL_INSERTS_6 
            ON SEQ_MA_EVENT_ID.Monotonically_Increasing_Id = SQ_MA_DC_COST_ADJ_CTRL_INSERTS_6.Monotonically_Increasing_Id""")
...
ORIG_MA_AMT AS ORIG_MA_AMT,
START_DT AS START_DT,
UPDATE_DT AS UPDATE_DT FROM EXP_NEW_7""")
